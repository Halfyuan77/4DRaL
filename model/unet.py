...
class UNet(nn.Module):
    ...
    def forward(self, x):
        ...
        total_batches, width = x.size(0), x.size(-1)
...
class UNet_tiny(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=False):
        ...
        self.down3 = (Down(self.dim*4, self.dim*8))
        factor = 2 if bilinear else 1
        self.up1 = (Up(self.dim*8, self.dim*4 // factor, bilinear))
        self.up2 = (Up(self.dim*4, self.dim*2 // factor, bilinear))
        self.up3 = (Up(self.dim*2, self.dim // factor, bilinear))
        self.outc = (OutConv(self.dim, n_classes))
        self.sigmoid = nn.Sigmoid()
...
class UNet_encoder(nn.Module):
    def __init__(self, n_channels, bilinear=False):
        ...
        self.down3 = (Down(self.dim*4, self.dim*8))
        factor = 2 if bilinear else 1
        self.down4 = (Down(self.dim*8, self.dim*8))
